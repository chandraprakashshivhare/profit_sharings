...
/** MongoDB filter for transaction list + CSV (dashboard period + optional type / director_id / project_id). */
export function buildTransactionsListQuery({ period = 'all', month, year, type, directorId, projectId }) {
